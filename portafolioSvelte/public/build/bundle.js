    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			h4 = element("h4");
    			h4.textContent = "Desarrollo aplicaciones, amo lo que hago, me encantan los animales.";
    			t12 = space();
    			img1 = element("img");
    			t13 = space();
    			br3 = element("br");
    			...
    			add_location(img1, file, 32, 1, 1058);
    			add_location(br3, file, 33, 1, 1174);
    			add_location(br4, file, 34, 1, 1180);
    			...
    			add_location(img2, file, 35, 1, 1186);
    			add_location(br5, file, 38, 3, 1348);
    			add_location(br6, file, 39, 3, 1356);
    			attr_dev(h11, "class", "display-4 text-center p-5 text-white");
    			add_location(h11, file, 40, 3, 1364);
    			attr_dev(p, "class", "lead text-white text-center");
    			add_location(p, file, 42, 4, 1485);
    			attr_dev(div1, "class", "text-wrap mx-auto");
    			add_location(div1, file, 41, 3, 1448);
    			add_location(br7, file, 44, 3, 1774);
    			add_location(br8, file, 45, 3, 1782);
    			add_location(br9, file, 46, 3, 1790);
    			attr_dev(div2, "class", "p-3 mb-2 bg-warning");
    			add_location(div2, file, 37, 2, 1310);
    			set_style(div3, "position", "relative");
    			add_location(div3, file, 36, 1, 1274);
    			...
    			add_location(script0, file, 62, 1, 2100);
    			...
    			add_location(script1, file, 63, 1, 2282);
    			...
    			add_location(script2, file, 64, 1, 2489);
